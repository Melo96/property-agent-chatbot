...
# Response #
Your response should be exactly one word. 
If the question should be rephrased return one word: true
otherwise return another word: false
