...
doc_src_path = Path('/Users/yangkaiwen/Documents/hypergai-chatbot-data/handbook_demo')
data_save_path = Path('/Users/yangkaiwen/Documents/hypergai-chatbot/dev/data')
...
vectorstore = Chroma(
    ...
    persist_directory=os.path.join(data_save_path, db_name),
)
